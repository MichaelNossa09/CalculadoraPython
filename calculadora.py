...
class Interfaz:
    def __init__(self, ventana):
        ...
        self.pantalla=Text(ventana, state="disabled", width=30, height=5,  background="#1F618D", foreground="white", font=("",13))
        ...
        boton17 = self.crearBoton("=", escribir=False, ancho=15, alto=1)
        ...
        botones[16].grid(row=5,column=0, columnspan=4, padx=3, pady=3)

        return

    def crearBoton(self, valor, escribir=True, ancho=5, alto=0):
        return Button(self.ventana, text=valor, width=ancho, height=alto,font=("Helvetica", 13),command=lambda:self.click(valor,escribir))
